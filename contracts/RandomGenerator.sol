...
// File: contracts/interfaces/IRoyalBetting.sol
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public royalBetting;
    bytes32 public keyHash;
    bytes32 public latestRequestId;
    uint32 public  randomResult;
    uint256 public fee;
    uint256 public latestBettingId;
    ...
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == royalBetting, "Only Royal Betting");
    ...
    /**
     * @notice Set the address for the RoyalBettiing
     * @param _royalBetting: address of the RoyalBettiing
     */
    function setRoyalBetting(address _royalBetting) external onlyOwner {
        royalBetting = _royalBetting;
    }
    ...
    /**
     * @notice View latestBettingId
     */
    function viewLatestBettingId() external view override returns (uint256) {
        return latestBettingId;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestBettingId = IRoyalBetting(royalBetting).viewcurrentBettingId();
    }
}